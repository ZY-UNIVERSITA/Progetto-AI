...
MODEL_REPOSITORY = {"CNN_v0": CNN_v0, "CNN_v1": CNN_v1, "CNN_v3": CNN_v3, "else": CNNModel}
...
def get_model(
    ...
    if name not in MODEL_REPOSITORY:
        return CNNModel(cfg=model_cfg, num_classes=num_classes, num_channels=num_channels, img_size=img_size)
